            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/homeplate_logo_black.svg"
                    alt="logo"
                  ...
                  />
                  <Image
                    src="/images/logo/homeplate_logo_large.svg"
                    alt="logo"
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Lightning-fast, intuitive mobile applications.
                </p>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Contact us at: admin@homeplate24.com
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  {/* <li>
                    <a
                      href="https://tarun16.github.io/CitizenshipAppData/privacy-policy.html"
                      target="__blank"
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Terms of Service
